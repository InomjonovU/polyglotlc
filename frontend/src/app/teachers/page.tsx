          ...
          {teachers.map((teacher, i) => (
            ...
            >
              <Link
                ...
                className="card group hover:border-primary hover:-translate-y-1 transition-all duration-300 block"
              >
                ...
                <h3 className="text-lg font-bold group-hover:text-primary transition-colors">{teacher.full_name}</h3>
                ...
                {teacher.experience_years > 0 && (
                  <p className="text-text-secondary text-xs mt-1 flex items-center gap-1">
                    <Briefcase size={12} /> {teacher.experience_years} yillik tajriba
                  </p>
                )}
                ...
                <div className="flex items-center gap-1 text-primary text-sm font-semibold mt-4 pt-3 border-t border-border group-hover:gap-2 transition-all">
